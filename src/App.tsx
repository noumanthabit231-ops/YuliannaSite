...
«Оферта» - публичное предложение на использование онлайн сервиса;
«Акцепт» - безоговорочное принятие Пользователем условий договора в полном объеме;
«Администратор» - сервис-провайдер, являющийся собственником сайта;
«Пользователь» - любое физическое/юридическое лицо, которое принимает условия договора и пользуется услугами представленными на сайте Администратора;
«Услуги» - «НАИМЕНОВАНИЮ ПРЕДОСТАВЛЯЕМЫХ УСЛУГ»;
 «Сайт» - совокупность программных средств, обеспечивающих публикацию для всеобщего обозрения информации и данных, объединенных общим целевым назначением, посредством технических средств. Сайт доступен Пользователям по уникальному электронному адресу или его буквенному обозначению. Под Сайтом в Соглашении понимается Сайт Администрации, расположенный в сети Интернет по адресу «ПОЛНЫЙ АДРЕС САЙТА»
2. Предмет оферты
2.1. Администратор предоставляет услуги по «НАИМЕНОВАНИЮ ПРЕДОСТАВЛЯЕМЫХ УСЛУГ» на Сайте.
2.2. Администратор обязуется оказывать техническое обслуживание и поддержку Сайта.
2.3. Действующая редакция Договора находится на Сайте в публичном доступе по адресу: «ПОЛНЫЙ АДРЕС САЙТА».
...
Статус Пользователя (физическое/юридическое лицо);
Адрес проживания;
ИИН/БИН
...
Не несет ответственность в связи с информацией, предоставленной Пользователем.
Имеет право в одностороннем порядке изменять условия предоставления Услуг и вносит изменения в редакцию Договора.

5.2. Пользователь:
Несет полную ответственность за правильность информации, введенной при регистрации на Сайте Администратора, а также за несвоевременное представление изменений в регистрационные данные;
Несет личную ответственность за любые действия, совершенные с использованием своего личного кабинета, а также за любые последствия, которые могло повлечь или повлекло такое использование третьими лицами при ненадлежащем хранении Пользователем логина и пароля.
Имеет право пользоваться услугами Сайта в своих интересах, непосредственно не вмешиваясь в его работу.
6. Порядок оплаты
