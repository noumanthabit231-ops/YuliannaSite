...
Настоящая политика конфиденциальности и обработки персональных данных регулирует порядок обработки и использования персональных и иных данных онлайн ресурса НАИМЕНОВАНИЕ ИП/ЮР.ЛИЦА дальше — Оператор). Действующая редакция настоящей Политики конфиденциальности, постоянно доступна для ознакомления, и размещена в сети Интернет по адресу: ССЫЛКА НА ОНЛАЙН РЕСУРС (САЙТ/БОТ)
...
1.ТЕРМИНЫ
1.1. онлайн ресурс – сайт/телеграм-бот, расположенный в сети Интернет по адресу ССЫЛКА НА ОНЛАЙН РЕСУРС (САЙТ/БОТ)
...
3.5.2 передача необходима в рамках использования Пользователем онлайн ресурса или оказания Услуг Пользователю;
...
5.6. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать по электронной почте АДРЕС ЭЛЕКТРОННОЙ ПОЧТЫ или по телефонам: НОМЕР ТЕЛЕФОНА]
            </div>
          </div>
        </div>
      </section>
